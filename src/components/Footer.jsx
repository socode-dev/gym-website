...
const Footer = ({ DumbbellIcon, LocationOnIcon, PhoneIcon, EmailIcon }) => {
  ...
  return (
    <footer className="w-full h-auto text-black dark:text-white bg-neutral-100 shadow-3xl dark:bg-neutral-800 dark:border-t-4 dark:border-t-neutral-900">
      <div className="p-4 lg:flex ">
        ...
        <div className="px-5 py-5 w-full h-auto grid grid-cols-1 mobile:grid-cols-2 tablet:grid-cols-3 laptop:px-20 gap-2">
